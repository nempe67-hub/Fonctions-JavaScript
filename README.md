Ce checkpoint s'inscrit dans le cadre du Projet JavaScript 2 initié par le HackerSpace 
GomyCode.
Il consiste à écrire des fonctions en utlisant le langage Jvvascript.
Pour notre part, nous avons écris le code de ces fonctions en utlisant le langage JavaScript 
et placé ce code dans des balises html; pour la partie design, nous avons utilisé le CSS.
...
2 - La Fonction Compter_les_caractères:
Cette fonction compte le nombre de caractères contenus dans une chaîne de caractères saisie,
les espaces n'étant pas pris en compte.
...
5 - La Fonction Somme :
Elle calcule la somme de tous les éléments (c'est-à-dire des nombres) d'un tableau.
...
8 - La Fonction Vérifier_si_Nombre_Premier :
Elle sert à vérifier si un nombre est premier ou non.

9 - La Fonction Suite_de_Fibonacci:
Elle génère la suite de Fibonacci jusqu'à un nombre donné de termes.
